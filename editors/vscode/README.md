...
> **Versioning Note**: Versions ending in `-dev` (e.g. `0.3.0-dev`) are for local development and testing. For VS Code Marketplace publishing, a standard semantic version (X.Y.Z) is required.
