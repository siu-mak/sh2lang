...
- [v0.2.0](docs/releases/v0.2.0.md) — Codegen modularization, import aliases, sudo lowering, test harness improvements.
- [v0.1.2](docs/releases/v0.1.2.md) — Adds for-loop ranges, job control (`spawn`/`wait`), file/stdin iterators, `which()`, `glob()`.
