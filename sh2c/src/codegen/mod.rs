...
use self::helpers::{sh_single_quote, is_boolean_val, is_boolean_expr, emit_case_glob_pattern};
...
mod emit_val;
use self::emit_val::{emit_val, emit_word, emit_cond, emit_cmd_body_raw, emit_cmd_pipe_body_raw};
