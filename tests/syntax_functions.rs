...
#[test]
fn codegen_call_func() { assert_codegen_matches_snapshot("call_func"); }
#[test]
fn codegen_call_args() { assert_codegen_matches_snapshot("call_args"); }
#[test]
fn codegen_func_args_basic() { assert_codegen_matches_snapshot("func_args_basic"); }
#[test]
fn codegen_func_params_basic() { assert_codegen_matches_snapshot("func_params_basic"); }
#[test]
fn codegen_func_params_10() { assert_codegen_matches_snapshot("func_params_10"); }
#[test]
fn codegen_return_basic() { assert_codegen_matches_snapshot("return_basic"); }
#[test]
fn codegen_return_arg() { assert_codegen_matches_snapshot("return_arg"); }
#[test]
fn codegen_return_number() { assert_codegen_matches_snapshot("return_number"); }
#[test]
fn codegen_return_len() { assert_codegen_matches_snapshot("return_len"); }
#[test]
fn codegen_hello() { assert_codegen_matches_snapshot("hello"); }
...
#[test]
fn codegen_return_status() { assert_codegen_matches_snapshot("return_status"); }

#[test]
fn exec_return_status() { assert_exec_matches_fixture("return_status"); }

// --- Backfill: Multi-Run ---

#[test]
fn codegen_multi_run() { assert_codegen_matches_snapshot("multi_run"); }