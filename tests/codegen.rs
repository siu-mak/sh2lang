...
#[test]
fn if_exists_codegen_matches_snapshot() {
    assert_codegen_matches_snapshot(
        "tests/fixtures/if_exists.sh2",
        "tests/fixtures/if_exists.sh.expected",
    );
}

#[test]
fn if_is_dir_codegen_matches_snapshot() {
    assert_codegen_matches_snapshot(
        "tests/fixtures/if_is_dir.sh2",
        "tests/fixtures/if_is_dir.sh.expected",
    );
}
...
#[test]
fn source_basic_codegen_matches_snapshot() {
    assert_codegen_matches_snapshot(
        "tests/fixtures/source_basic.sh2",
        "tests/fixtures/source_basic.sh.expected",
    );
}

#[test]
fn func_args_basic_codegen_matches_snapshot() {
    assert_codegen_matches_snapshot(
        "tests/fixtures/func_args_basic.sh2",
        "tests/fixtures/func_args_basic.sh.expected",
    );
}
...
#[test]
fn index_list_literal_codegen_matches_snapshot() {
    assert_codegen_matches_snapshot(
        "tests/fixtures/index_list_literal.sh2",
        "tests/fixtures/index_list_literal.sh.expected",
    );
}

#[test]
fn index_list_var_codegen_matches_snapshot() {
    assert_codegen_matches_snapshot(
        "tests/fixtures/index_list_var.sh2",
        "tests/fixtures/index_list_var.sh.expected",
    );
}
...
#[test]
fn func_params_basic_codegen_matches_snapshot() {
    assert_codegen_matches_snapshot(
        "tests/fixtures/func_params_basic.sh2",
        "tests/fixtures/func_params_basic.sh.expected",
    );
}

#[test]
fn func_params_10_codegen_matches_snapshot() {
    assert_codegen_matches_snapshot(
        "tests/fixtures/func_params_10.sh2",
        "tests/fixtures/func_params_10.sh.expected",
    );
}
