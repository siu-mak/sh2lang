...
fn exec_heredoc_basic() {
    assert_codegen_matches_snapshot("heredoc_basic");
...
fn exec_heredoc_no_trailing_newline() {
    ...
    assert_codegen_matches_snapshot("heredoc_no_trailing_newline");
...
fn exec_heredoc_delim_collision() {
    ...
    assert_codegen_matches_snapshot("heredoc_delim_collision");
